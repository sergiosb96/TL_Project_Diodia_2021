...
const scopeName = "passesanalysis";
const method = "get";
...
const scopeParameters = [
  {
    op1: /[a-zA-Z][a-zA-Z0-9_\-]*/,
    op2: /[a-zA-Z][a-zA-Z0-9_\-]*/,
    datefrom: /\d{8}/,
    dateto: /\d{8}/,
    format: /^(csv|json)$/,
  },
...
// PassesAnalysis endpoint: {baseUrl}/PassesAnalysis/:op1_ID/:op2_ID/:date_from/:date_to
class PassesAnalysis extends Scope {
  constructor() {
  ...
  async run(baseUrl, parameters) {
    ...
    const apiParameters = {
      url: [
        parametersObject.op1, // /:op1
        parametersObject.op2, // /:op2
