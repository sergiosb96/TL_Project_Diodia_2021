...
// ResetStations endpoint: {baseUrl}/admin/resetstations
class ResetStations extends Scope {
  constructor() {
  ...
  async run(baseUrl, parameters) {
    ...
    const apiParameters = {}; // (no parameters needed for ResetPasses)
